...
class abt_featured_content {
	...
	public function add_type_boxes(){
		add_meta_box($this->postType . '_options',__($this->singular . ' Options','snapsite'),array(&$this, 'meta_boxes'),$this->postType,'normal','default');
	}
	...
	public function meta_boxes(){
		...
		if( empty($meta) ) $meta = array('text'=>'', 'link'=>'');	// prevent warnings
	...
	function on_save($id) {
		...
		if (!wp_verify_nonce($_POST["{$this->postType}-nonce"],"{$this->postType}-nonce")) return $id; //nonce
